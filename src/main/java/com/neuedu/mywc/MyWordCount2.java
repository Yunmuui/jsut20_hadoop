 ...
 * @Filename: MyWordCount2
 * @Author: Zhangjunnan
 * @Data: 2022/12/26 11:14
 * @Description: TODO
 */
public class MyWordCount2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 设置自定义Mapper
            job.setMapperClass(MyWordCount2.WordCountMapper.class);
            job.setMapOutputKeyClass(Text.class);
            job.setOutputValueClass(IntWritable.class);
            // 设置自定义Reducer
            job.setReducerClass(MyWordCount2.WordCountReducer.class);
            job.setMapOutputKeyClass(Text.class);
            job.setOutputValueClass(IntWritable.class);
            // 设置输出文件
